...
namespace GourmetShopMVC.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(GourmetShopMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName,ParentCategoryId")] Categories categories)
        {
